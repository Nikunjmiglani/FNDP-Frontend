        ...
        <div className="flex flex-wrap justify-center gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md text-center max-w-xs w-full">
            ...
            <div className="flex justify-center gap-4 text-purple-600 text-lg">
              <a href="https://www.nikunj.space/" target='/'><CgProfile className='text-xl  hover:scale-110 transition-transform duration-200 mt-1' /></a>
              <a href="https://x.com/NikunjMiglani28"><i className="fab fa-twitter  hover:scale-110 transition-transform duration-200"></i></a>
              <a href="https://github.com/Nikunjmiglani"><i className="fab fa-github  hover:scale-110 transition-transform duration-200"></i></a>
              <a href="https://www.linkedin.com/in/nikunjmiglani/"><i className="fab fa-linkedin-in  hover:scale-110 transition-transform duration-200"></i></a>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md text-center max-w-xs w-full">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Glavi amet rinsit libero molestie ante ut fringilla purus eros quis gravida
              from dolor amet ipsum lorem bibendum
            </p>
